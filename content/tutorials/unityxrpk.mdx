...
In this brief guide, we'll learn how to create Multi Apps (using WebXR and XR Pacakges) in Unity.
Working in Unity offers a great many advantages, and if it's your preferred development environment, it's probably the easiest way to get started creating Multi Apps.
...
4. Building an XR Package and loading it in pluto's Multi App Manager[LINK]
...
a. Create a new Unity Project. Make sure to use the 3D Pipeline (rather than URP or HDRP)
![](./unity_xrpk/1.png)
...
a. Once you're ready to build, go to File / Build and Run, "Add Open Scenes". Hit Build and choose your destination.
![](./unity_xrpk/9.png)
...
b. Once you have built your app, go to the build folder you chose. Note that aside from the regular files you'd expect from a Unity WebGL export (`index.html`, etc.) there's a .wbn file bearing the name of your project. That is your multi app!
![](./unity_xrpk/10.png)
...
d. finally, open the [Pluto Multi App Launcher](https://chimera.pluto.app/) on Metachromium[LINK], go to "Add XR Package or Model" and choose and `Custom XRPK (from file)`:
![](./unity_xrpk/12.png)
