...
Multi Apps are inherently social; every Multi App is inherently shareable. By loading it into the [Pluto Multi App Launcher](http://chimera.pluto.app/), every Pluto conversation member automatically loads an identical copy.
